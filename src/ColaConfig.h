 ...
 *
 * Include file for the configuration of Cola.
 *
...
#ifndef __COLACONFIG_H__
#define __COLACONFIG_H__

#ifdef HAVE_CONFIG_H
#ifdef COLA_BUILD
#include "config.h"
#else
#include "config_cola.h"
#endif
...
#else
#include "config_cola_default.h"
#endif

#endif /* HAVE_CONFIG_H */

#endif /*__COLACONFIG_H__*/
